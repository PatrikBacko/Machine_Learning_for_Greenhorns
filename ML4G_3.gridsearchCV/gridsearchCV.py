...
parser.add_argument("--test_size", default=0.7, type=lambda x: int(x) if x.isdigit() else float(x), help="Test size")
...
def main(args: argparse.Namespace) -> float:
    ...
    grid = {"poly__degree":[1,2], "lr__C":[0.01,1,100], "lr__solver":["lbfgs","sag"]}
